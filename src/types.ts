...
export type Section = 'profile' | 'analysis' | 'add-work' | 'history' | 'report' | 'settings' | 'org-dashboard' | 'contractor-dashboard' | 'worker-search' | 'help' | 'shortlist' | 'impact' | 'community' | 'org-analysis' | 'financial' | 'support' | 'hire-workers' | 'live-workforce' | 'job-board';
