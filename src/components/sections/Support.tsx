      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          { 
            ...
            icon: MessageSquare, 
            color: 'text-blue-500', 
            onClick: () => window.open('https://wa.me/919999999999?text=Hello%20Karmika%20Setu%20Support', '_blank')
          },
          { 
            label: 'Call Support', 
            icon: Phone, 
          ...
          { 
            ...
            color: 'text-rose-500', 
            onClick: () => {
              const subject = encodeURIComponent('Grievance Report - Karmika Setu');
              const body = encodeURIComponent('Please describe your issue here...');
              window.location.href = `mailto:support@karmikasetu.org?subject=${subject}&body=${body}`;
            }
          },
        ].map((item, idx) => (
          <button 
