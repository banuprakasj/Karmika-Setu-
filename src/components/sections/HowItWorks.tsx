  ...
  const workerFAQs: FAQSection[] = [
    {
      ...
      items: [
        {
          question: "What is Karmika Setu?",
          answer: "Karmika Setu is a digital platform designed to bridge the gap between unorganized labor and formal institutions. It helps you build a verified work history that can be used to access banking services, insurance, and better job opportunities."
        },
        {
        ...
        },
        {
          ...
          answer: "Banks and financial institutions look for evidence of steady income. By regularly logging your work on Karmika Setu, you create a 'Digital Credit Score' based on your actual work consistency, which organizations can verify via your unique Setu ID."
        },
        {
      ...
      items: [
        {
          ...
          answer: "Yes. Your Aadhaar is only used for one-time verification. Karmika Setu follows strict Indian data privacy norms and never shares your personal details without your explicit consent."
        },
        {
  ...
  return (
    <div className="space-y-8 pb-12">
      <header>
        ...
        <p className="text-brand-muted">Everything you need to know about navigating the Karmika Setu ecosystem.</p>
      </header>
