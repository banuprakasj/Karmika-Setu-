...
export default function CompleteProfile({ t }: CompleteProfileProps) {
      ...
      >
        <div className="p-8 text-center">
          ...
          <h1 className="font-display font-black text-2xl tracking-tight uppercase mb-2 text-brand-ink">
            {isContractor ? t?.contractorSetup || 'Contractor Setup' : t?.completeProfile || 'Complete Your Profile'}
          </h1>
          <p className="text-sm text-brand-muted mb-8">
            {isContractor 
              ? t?.setupDesc || 'Professional details to manage your crew and projects.' 
              : t?.profileDesc || 'Just a few more details to get you started as a Worker.'}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-brand-muted ml-1">{t?.fullName || 'Full Name'}</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-brand-muted ml-1">{t?.phoneNumber || 'Phone Number'}</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-brand-muted ml-1">{t?.aadhaarNumber || 'Aadhaar Number'}</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-brand-muted ml-1">{t?.panCard || 'PAN Card'} (Optional)</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-brand-muted ml-1">{t?.currentAddress || 'Current Address'}</label>
              <div className="relative">
